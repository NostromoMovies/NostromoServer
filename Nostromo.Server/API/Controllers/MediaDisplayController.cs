    ...
    public class MediaDisplayController : ControllerBase
    {
        ...
        public async Task<IActionResult> LinkMovie([FromBody] LinkMovieRequest request)
        {
            try
            {
                ...
                // Schedule DownloadMovieMetadataJob
                ...
                var metadataJob = JobBuilder.Create<DownloadMovieMetadataJob>()
                    .UsingJobData(DownloadMovieMetadataJob.HASH_KEY, video.ED2K) // Use file hash as identifier
                ...
                // Schedule DownloadTMDBMetadataJob
                ...
                var tmdbJob = JobBuilder.Create<DownloadTMDBMetadataJob>()
                    .UsingJobData(DownloadTMDBMetadataJob.MOVIE_ID_KEY, request.TMDBMovieID) // Use TMDB Movie ID
